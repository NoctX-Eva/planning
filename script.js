...
const firebaseConfig = {
  apiKey: "AIzaSyCT07-YjdnzNoKsBfxbZCjcXPhsTt-beWg",
  authDomain: "ctr-eva.firebaseapp.com",
  projectId: "ctr-eva",
  storageBucket: "ctr-eva.firebasestorage.app",
  messagingSenderId: "7894129923",
  appId: "1:7894129923:web:1e9531a3eeb767249d9d36"
};
...
async function loadAll() {
  ...
  snapA.forEach(d => {
    ...
    events.push({
      ...
      start: data.date,
      backgroundColor: "#2a0039",   // 👈 couleur joueurs
      borderColor: "#2a0039",
      textColor: "#ffffff",
  ...
  snapE.forEach(d => {
    ...
    events.push({
      ...
      start: data.date,
      backgroundColor: "#b950df",   // 👈 couleur events
      borderColor: "##b950df",
      textColor: "#2a0039",
